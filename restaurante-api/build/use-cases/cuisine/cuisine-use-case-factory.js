...
var cuisine_use_case_factory_exports = {};
__export(cuisine_use_case_factory_exports, {
  makeCreateCuisineUseCase: () => makeCreateCuisineUseCase,
  makeDeleteCuisineUseCase: () => makeDeleteCuisineUseCase,
  makeFindAllCuisinesUseCase: () => makeFindAllCuisinesUseCase,
  makeFindCuisineByIdUseCase: () => makeFindCuisineByIdUseCase,
  makeUpdateCuisineUseCase: () => makeUpdateCuisineUseCase
});
module.exports = __toCommonJS(cuisine_use_case_factory_exports);
