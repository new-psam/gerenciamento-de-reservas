...
__decorateClass([
  (0, import_typeorm5.PrimaryGeneratedColumn)("uuid", { name: "id" })
...
__decorateClass([
  (0, import_typeorm5.ManyToOne)(() => Restaurant, (restaurant) => restaurant.reservations),
  (0, import_typeorm5.JoinColumn)({ name: "restaurant_id" })
], Reservation.prototype, "restaurants", 2);
__decorateClass([
  (0, import_typeorm5.ManyToOne)(() => User, (user) => user.reservations),
  (0, import_typeorm5.JoinColumn)({ name: "user_id" })
], Reservation.prototype, "users", 2);
__decorateClass([
  (0, import_typeorm5.ManyToOne)(() => RestaurantSlot, (slot) => slot.reservations),
  (0, import_typeorm5.JoinColumn)({ name: "slot_id" })
...
__decorateClass([
  (0, import_typeorm6.OneToMany)(() => Reservation, (reservation) => reservation.users)
