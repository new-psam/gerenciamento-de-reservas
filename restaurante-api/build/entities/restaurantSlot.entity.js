...
var restaurantSlot_entity_exports = {};
__export(restaurantSlot_entity_exports, {
  RestaurantSlot: () => RestaurantSlot
});
module.exports = __toCommonJS(restaurantSlot_entity_exports);
...
__decorateClass([
  (0, import_typeorm6.ManyToOne)(() => Restaurant, (restaurant) => restaurant.slots),
  (0, import_typeorm6.JoinColumn)({ name: "restaurant_id" })
], RestaurantSlot.prototype, "restaurant", 2);
__decorateClass([
  (0, import_typeorm6.OneToMany)(() => Reservation, (reservation) => reservation.slots)
