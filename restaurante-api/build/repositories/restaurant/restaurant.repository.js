...
// src/repositories/restaurant/restaurant.repository.ts
var restaurant_repository_exports = {};
__export(restaurant_repository_exports, {
  RestaurantRepository: () => RestaurantRepository
});
module.exports = __toCommonJS(restaurant_repository_exports);
...
__decorateClass([
  (0, import_typeorm3.OneToMany)(() => Reservation, (reservation) => reservation.users)
...
__decorateClass([
  (0, import_typeorm4.PrimaryGeneratedColumn)("uuid", { name: "id" })
...
__decorateClass([
  (0, import_typeorm4.ManyToOne)(() => Restaurant, (restaurant) => restaurant.reservations),
  (0, import_typeorm4.JoinColumn)({ name: "restaurant_id" })
], Reservation.prototype, "restaurants", 2);
__decorateClass([
  (0, import_typeorm4.ManyToOne)(() => User, (user) => user.reservations),
  (0, import_typeorm4.JoinColumn)({ name: "user_id" })
], Reservation.prototype, "users", 2);
__decorateClass([
  (0, import_typeorm4.ManyToOne)(() => RestaurantSlot, (slot) => slot.reservations),
  (0, import_typeorm4.JoinColumn)({ name: "slot_id" })
...
__decorateClass([
  (0, import_typeorm5.ManyToOne)(() => Restaurant, (restaurant) => restaurant.slots),
  (0, import_typeorm5.JoinColumn)({ name: "restaurant_id" })
], RestaurantSlot.prototype, "restaurant", 2);
__decorateClass([
  (0, import_typeorm5.OneToMany)(() => Reservation, (reservation) => reservation.slots)
...
__decorateClass([
  (0, import_typeorm6.OneToOne)(() => Address),
  (0, import_typeorm6.JoinColumn)({ name: "address_id" })
], Restaurant.prototype, "address", 2);
__decorateClass([
  (0, import_typeorm6.ManyToMany)(() => Cuisine, (cuisine) => cuisine.restaurants)
], Restaurant.prototype, "cuisines", 2);
__decorateClass([
  (0, import_typeorm6.OneToMany)(() => RestaurantSlot, (slot) => slot.restaurant)
], Restaurant.prototype, "slots", 2);
__decorateClass([
  (0, import_typeorm6.OneToMany)(() => Reservation, (reservation) => reservation.restaurants)
...
// src/repositories/restaurant/restaurant.repository.ts
var RestaurantRepository = class extends BaseRepository {
  constructor() {
    super(Restaurant);
  }
  ...
  async create(restaurant) {
    const newRestaurant = this.repository.create(restaurant);
